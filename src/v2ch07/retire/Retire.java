...
class RetireFrame extends JFrame {
    ...
    public RetireFrame() {
        ...
        int localeIndex = 0; // US locale id  default selection
    ...
    public void setCurrentLocale(Locale locale) {
        ...
        res = ResourceBundle.getBundle("src.v2ch07.retire.RetireResources", currentLocale);
        resStrings = ResourceBundle.getBundle("src.v2ch07.retire.RetireStrings", currentLocale);
    ...
    public void updateDisplay() {
        ...
        savingLabel.setText(resStrings.getString("savings"));
...
class RetireInfo {
    ...
    /**
     * Gets the excepted age of death.
     * @return the age
     */
...
class RetireComponent extends JComponent {
    ...
    /**
     * Sets the retirement information to be the plotted.
    ...
    public void paintComponent(Graphics g) {
        ...
        for (i = info.getCurrentAge();  i<= info.getDeathAge() - info.getCurrentAge(); i++) {
