...
/**
 * This program demonstrates collating string under various locales.
 */
 ...
 * a text field and button to add new strings, and text area to list the collated strings.
 */
class CollationFrame extends JFrame {
    ...
    public CollationFrame() {
        ...
        Arrays.sort(
                locales, (l1, l2) -> collator.compare(l1.getDisplayName(), l2.getDisplayName())
        );
        ...
        strengthCombo.addActionListener(actionListener);
        decompositionCombo.addActionListener(actionListener);
        pack();
    }
