...
public class LocalDates {
    public static void main(String[] args) {
        ...
        LocalDate independencyDay = LocalDate.of(2018, Month.JULY, 4);
        LocalDate christmas = LocalDate.of(2018, Month.DECEMBER, 25);

        System.out.println("Until christmas: " + independencyDay.until(christmas));
        System.out.println("Until christmas: " + independencyDay.until(christmas, ChronoUnit.DAYS));
